...
private val Context.codexUsageDataStore by preferencesDataStore(name = "codex_usage_cache")

@Singleton
class CodexUsageDataStore @Inject constructor(
    ...
    val cachedUsage: Flow<CodexUsage?> = context.codexUsageDataStore.data.map { preferences ->
    ...
    suspend fun save(usage: CodexUsage) {
        context.codexUsageDataStore.edit { preferences ->
    ...
    suspend fun clear() {
        context.codexUsageDataStore.edit { it.clear() }
    }
}
